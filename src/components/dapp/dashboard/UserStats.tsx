...
export const UserStats: React.FC = () => {
  const { userStats, isLoading } = useTrashCanStats();
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      <StatCard
        ...
        value={userStats.totalCollected.toLocaleString()}
        icon={
      ...
      <StatCard
        title="Total Earned"
        value={`${userStats.totalEarned.toLocaleString()} TRASH`}
        icon={
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-electric" viewBox="0 0 20 20" fill="currentColor">
      ...
      <StatCard
        title="Active Cans"
        value={userStats.activeCans.toLocaleString()}
        icon={
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-electric" viewBox="0 0 20 20" fill="currentColor">
      ...
      <StatCard
        title="Achievements"
        value={userStats.achievements.toLocaleString()}
        icon={
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-electric" viewBox="0 0 20 20" fill="currentColor">
