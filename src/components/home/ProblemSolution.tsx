...
const ProblemSolution: React.FC = () => {
  ...
  return (
    <Section 
      id="problem-solution" 
      className="pt-0 -mt-56 md:-mt-64 relative z-10"
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <Card variant="elevated" className="p-8 h-full rounded-xl border border-gray-100 shadow-lg bg-white/90 backdrop-blur-sm">
            <div className="flex items-center mb-8">
              <div className="w-14 h-14 bg-red-100 rounded-full flex items-center justify-center mr-4 shadow-sm">
        ...
        >
          <Card variant="elevated" className="p-8 h-full rounded-xl border border-gray-100 shadow-lg bg-white/90 backdrop-blur-sm">
            <div className="flex items-center mb-8">
              <div className="w-14 h-14 bg-forest/10 rounded-full flex items-center justify-center mr-4 shadow-sm">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 text-forest" fill="none" viewBox="0 0 24 24" stroke="currentColor">
